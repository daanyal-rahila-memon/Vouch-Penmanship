...
const {
  ...
  isAdmin,
  isSupervisor,
} = require("../controllers/auth"); // things to be imported from controllers/auth
const {
  getStudentById,
  getStudent,
  updateStudent,
  ...
  deleteStudent,
} = require("../controllers/student"); // things to be imported from controllers/student
...
router.put(
  ...
  isAuthenticated,
  updateStudentPassword
); // updates the student's password in the databse
