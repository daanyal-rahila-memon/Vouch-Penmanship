...
const { getSupervisorById, getSupervisor, updateSupervisor, updateSupervisorPassword, deleteSupervisor} = require("../controllers/supervisor"); // things to be imported from controllers/supervisor
