...
exports.signup = (req, res) => {
    ...
    // Student Signup Code
    const student = new Student(req.body);      // createing the object of Student (model)
    // console.log(student);
...
exports.isSignedIn = expressJwt({       // is to check whether the user loggen in or not by using created token
...
exports.isAuthenticated = (req, res, next) => {
    ...
    if (!checker)
    {
        res.status(403).json({      // status code = 403 means you're not allowed to do so
